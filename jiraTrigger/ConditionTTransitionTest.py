#Jython condition script for bypass JIRA trigger
...
if repr(provenance) != 'None' or (criticite == 'Normal' or criticite == 'Mineur') or not checkProjectType(project_id) or issueType != "Anomalie" or checkCurrentUserGroup(currentUser):
        result = True
else:
        result = False